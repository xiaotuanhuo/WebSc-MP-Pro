!function(a) {
    a.fn.jalendar = function(t) {
        ...
        $(".orange").on("click", function() {
        	...
        	var title = $("#restTitle").val();
        	var restBegin = $("#picktime_begin").val();
        	var restEnd = $("#picktime_end").val();
        	console.log(90909);
        	...
        	divDom2.setAttribute("data-title", title);
        	divDom2.setAttribute("data-id", "newId");
